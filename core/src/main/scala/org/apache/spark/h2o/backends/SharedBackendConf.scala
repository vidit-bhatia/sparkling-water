...
trait SharedBackendConf {
  ...
  def cloudName = sparkConf.getOption(PROP_CLUSTER_NAME._1)
  ...
  def setH2ONodeLogLevel(nodeLogLevel: String): H2OConf = {
    sparkConf.set(PROP_CLIENT_LOG_LEVEL._1, nodeLogLevel)
    self
  }

  def setH2ONodeLogDir(nodeLogDir: String): H2OConf = {
  ...
  def setH2OClientLogLevel(clientLogLevel: String): H2OConf = {
    sparkConf.set(PROP_CLIENT_LOG_LEVEL._1, clientLogLevel)
    self
  }

  def setH2OClientLogDir(clientLogDir: String): H2OConf = {
  ...
  def setScalaIntDefaultNum(numInstances: Int): H2OConf = {
    sparkConf.set(PROP_SCALA_INT_DEFAULT_NUM._1, numInstances.toString)
    self
  }

  def setH2OReplDisabled(): H2OConf = {
    sparkConf.set(PROP_REPL_ENABLED._1, false.toString)
    self
  }
  def setH2OReplEnabled(): H2OConf = {
